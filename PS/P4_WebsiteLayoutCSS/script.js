...
function changeTheme() {
    ...
    if (html.getAttribute('data-theme') == 'dark') {
        ...
        setTimeout(() => {document.getElementsByTagName('button')[0].innerHTML = MOON}, duration)
    }
    else {
        html.setAttribute('data-theme', 'dark');
        setTimeout(() => {document.getElementsByTagName('button')[0].innerHTML = SUN}, duration)
    }
}

document.getElementsByTagName('button')[0].innerHTML = MOON;
document.getElementsByTagName('button')[0].addEventListener('click', changeTheme);
